...
const api_url ="https://user-api-h24l.onrender.com/users";
...
<button
    className={`flex-1 py-2 text-lg sm:text-xl font-semibold transition-all duration-200 ${
      !issignUp
        ? "border-b-4 border-(--dark) text-(--dark)"
        : "text-gray-500"
    }`}
...
<div className="mb-4 relative">
    ...
    >
      {showConfirm ? <EyeOff size={18} /> : <Eye size={18} />}
                    ...
                    <button
            type="submit"
            className="w-full bg-(--dark) text-(--light) py-2 rounded-lg text-lg sm:text-xl font-semibold cursor-pointer"
